                ...
                <div className="md:flex">
                    <div className="md:w-1/2 lg:w-2/3">
                        <div className="relative">
                            ...
                            <Image src='/images/prpo_system_img/prpo-system-landing-page.png'
                            loading="lazy" 
                            alt="project-1"
                            width={1000}
                            height={1000}
                            className="rounded-lg mb-2 cursor-pointer scale-95 md:scale-95
                            hover:scale-100 duration-300 w-full h-auto"
                            />
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 lg:w-1/3 h-max">
                        <div className="relative">
                            ...
                            <Image src='/images/prpo_system_img/prpo-matcode-list.png'
                            loading="lazy" 
                            alt="project-1"
                            width={1000}
                            height={1000}
                        ...
                        <div className="relative hidden lg:block">
                            ...
                            <Image src='/images/prpo_system_img/prpo-request-details.png'
                            loading="lazy" 
                            alt="project-1"
                            width={1000}
                            height={1000}
                ...
                <div className="mb-4 md:flex">
                    <div className="md:w-1/2">
                        <div className="relative">
                            ...
                            <Image src='/images/ppic_system_img/ppic-system-landing.png'
                            loading="lazy" 
                            alt="project-1"
                            width={1000}
                            height={1000}
                    ...
                    <div className="md:w-1/2">
                        <div className="relative">
                            ...
                            <Image src='/images/facilities_system_img/facilities-pm-schedule.png'
                            loading="lazy" 
                            alt="project-1"
                            width={1000}
                            height={1000}
